...
class DQNEnvironment:
    ...
    def update_environment(self):
        ...
        elif self.memory['action'] == 0:
            if self.memory['S2'][4] is True:
                reward = -5
            elif self.memory['S2'][3] < 1 and self.memory['S2'][2] < 1 and self.memory['S2'][1] == 0:
                reward = 1 - 2*self.memory['S2'][0]
            elif self.memory['S2'][1] == 1:
                reward = -1
            else:
                reward = 0
        elif self.memory['action'] == 1:
            if self.memory['S2'][4] is True and self.memory['S2'][2] > 0 and self.memory['S2'][3] > -1 and self.memory['S2'][1] == 0:
                reward = 1
            elif self.memory['S2'][1] == 1:
                reward = -1
            else:
                reward = 0
        elif self.memory['action'] == 2:
            if self.memory['S2'][3] >= 1 and self.memory['S2'][1] == 1:
                reward = 1
            else:
                reward = 0
        elif self.memory['action'] == 3:
            if self.memory['S2'][4] is True:
                reward = -5
            elif self.memory['S2'][3] <= -1 and self.memory['S2'][1] == 1:
                reward = 1
            else:
                reward = 0
        elif self.memory['action'] == 4:
            if (self.memory['S2'][3] >= 1 or self.memory['S2'][3] <= -1) and self.memory['S2'][1] == 1:
                reward = 1
            elif self.memory['S2'][3] == 0 and self.memory['S2'][1] == 0:
                reward = 1
            else:
                reward = -1
        else:
